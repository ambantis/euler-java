...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Stopwatch stopwatch032 = new Stopwatch();
    Problem032 problem032 = new Problem032();
    int sumOfPandigitalsOutput = problem032.sumOfPandigitals();
    double pandigitalTime = stopwatch032.elapsedTime();
    System.out.println("Problem #032");
    System.out.println("============");
